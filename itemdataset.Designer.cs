...
namespace AllinOne.itemdatasetTableAdapters {
...
SELECT item_Id, item_name, catogery, quantity, unit_price FROM tblitem WHERE (item_Id = @item_Id)";
        ...
        public virtual int Fill(itemdataset.tblitemDataTable dataTable) {
        ...
        public virtual itemdataset.tblitemDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            itemdataset.tblitemDataTable dataTable = new itemdataset.tblitemDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(itemdataset.tblitemDataTable dataTable) {
